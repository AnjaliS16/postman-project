function handleFormSubmit(event) {
  ...
  axios.post("https://crudcrud.com/api/5663172a9fc34e54bf5c0790e9ac9e6e/appointmentData", obj)
    .then((response) => {
...
window.addEventListener("DOMContentLoaded", () => {
  axios.get("https://crudcrud.com/api/5663172a9fc34e54bf5c0790e9ac9e6e/appointmentData")
    .then((response) => {
      console.log(response)
...
function DeleteUser(id) {
  axios.delete(`https://crudcrud.com/api/5663172a9fc34e54bf5c0790e9ac9e6e/appointmentData/${id}`)
.then((res) => {
